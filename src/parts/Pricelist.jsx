            ...
            <div id="card-basic">
              <div class="card-body">
                ...
                {data.website_basic.map((item) => {
                  return (
                    <>
                      <h3 className="fake-price">Rp. {item.fake_price}</h3>{" "}
                      <h2 className="price-original">Rp. {item.real_price} </h2>
                    </>
                  );
                })}
                {data.website_basic.map((item) => {
                  return item.benefit.map((value) => {
                    return (
                      <div className="collect-benefit">
                        ...
                        <a
                          href="https://api.whatsapp.com/send?phone=62895366423269&text=Hai,%20saya%20tertarik%20untuk%20membuat%20website%20untuk%20bisnis%20saya%20dengan%20paket%20basic"
                          style={{ width: "100%" }}
                          target="_blank">
                          <Button
                      ...
                      return (
                        <div className="collect-benefit">
                          <div id="benefit">
                            ...
                            <p className="subtext-price-premium ms-2">
                              {value.usability}
                            </p>
                          </div>
                          <div id="benefit">
                          ...
                          <a
                            href="https://api.whatsapp.com/send?phone=62895366423269&text=Hai,%20saya%20tertarik%20untuk%20membuat%20website%20untuk%20bisnis%20saya%20dengan%20paket%20premium"
                            style={{ width: "100%" }}
                            target="_blank">
                            <Button
